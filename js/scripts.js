...
var array_contries_coords = raw_string.split('\n');
var countries_coords_map = {};
var tmp;
for ( var i = 0; i < array_contries_coords.length; i++ ) {
  tmp = array_contries_coords[i].split(',');
  countries_coords_map[tmp[2]] = "lat:" + tmp[0] + ", " + "lng:" + tmp[1];
}

function getCoordsMap() {
  return countries_coords_map;
}
